...
public class GradebookControllerTest {
    ...
    /**
     * Delete Student does not exists
     * @throws Exception
     */
    @Test
    ...
    /**
     * Get student information endpoint
     */
    @Test
    ...
    /**
     * Get student information where student does not exists
     */
    @Test
    ...
    /**
     * Create grade for studentId does not exist
     */
    @Test
    ...
    @Test
    public void createAValidGradeHttpRequestInvalidSubjectExistsEmptyResponse() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.post("/grades")
                        .content(String.valueOf(MediaType.APPLICATION_JSON))
                        .param("grade", "85.00")
    ...
    @Test
    public void deleteAValidGradeHttpRequestGradeTypeDoesNotExistsEmptyResponse() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/grades/{id}/{gradeType}", 2, "physics"))
                .andExpect(status().is4xxClientError())
                .andExpect(jsonPath("$.status", is(404)))
                .andExpect(jsonPath("$.message", is("Student or Grade was not found")));
    }
